        ...
        <div class="container">
            ...
            <div class="testimonial-content">
                <div class="testimonial-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/img-gestao-atendimento/testemunho.png" alt="Sandra Pereira">
                </div>
...
<path d="M41.2188 30.77L41.2188 58L73.6299 58L73.6299 32.9484L58.1289 -1.05885e-06L41.2188 -2.21395e-06L54.2537 30.77L41.2188 30.77ZM0.000423803 30.77L0.000420757 58L32.4115 58L32.4115 32.9484L16.9105 -3.87442e-06L0.000427246 -5.02952e-06L13.0353 30.77L0.000423803 30.77Z" fill="#FFF5F5" fill-opacity="0.5"/>
                    ...
                    <div class="testimonial-quote">
                        <blockquote>
                            A solução de gestão de atendimento da Multimac simplificou o fluxo de clientes na nossa clínica e reduziu os tempos de espera. Os nossos pacientes notaram a diferença e a equipa agora trabalha com mais eficiência.
                        </blockquote>
                    </div>
                    <div class="testimonial-client-info">
                        <h4>Sandra Pereira</h4>
                        <p>Administradora de Clínica Médica.</p>
                    </div>
                </div>
            </div>
        </div>
