...
$texto2         = $args['texto2'] ?? 'Preencha o formulário e receba uma solução ajustada às necessidades da sua empresa.';
...
?>
<section class="form-section" id="formularioprodutos">
  <div class="form-left">
